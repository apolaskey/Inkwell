...
namespace Inkwell.Framework
{
    ...
    static class BloomEffect
    {
        ...
        static EffectParameter weightsParameter, offsetsParameter;
        public static BloomSettings Settings { get { return settings; } set { settings = value; } }
        static Vector2 delta = Vector2.Zero;
        static int sampleCount = 0;
        static float[] sampleWeights;
        static Vector2[] sampleOffsets;
        //static int bloomSettingsIndex = 0;
        ...
        static void SetBlurEffectParameters(float dx, float dy)
        {
            ...
            if (sampleCount != weightsParameter.Elements.Count)
            {
        ...
        static void GaussianBlur(SpriteBatch SpriteBatch, Texture2D t2dTexture, bool BlurredHorizontally)
        {
            ...
            else SetBlurEffectParameters(0, 1.0f / (float)renderTarget1.Height);
